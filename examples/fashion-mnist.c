...
int main(int argc, char **argv)
{
    ...
    dahl_convolution* conv = convolution_init(network_arena, input_shape, 6, num_channels);
    dahl_pooling* pool = pooling_init(network_arena, 2, conv->output_shape);
    dahl_dense* dense = dense_init(network_arena, pool->output_shape, 10);
