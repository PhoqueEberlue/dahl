...
dahl_dense* dense_init(dahl_shape3d input_shape, size_t output_size);
dahl_vector* dense_forward(dahl_dense* dense, dahl_block* input_data);
dahl_block* dense_backward(dahl_dense* dense, dahl_vector const* dl_dout, dahl_fp learning_rate);
