...
// }
// 
// starpu_data_handle_t forward_pass(convolution conv, starpu_data_handle_t const input_handle)
// {
...
// 		starpu_data_handle_t const sub_filters = starpu_data_get_sub_data(conv.filters_handle, 1, i);
// 
...
// }
// 
// starpu_data_handle_t backward_pass(convolution conv, starpu_data_handle_t dl_dout, double const learning_rate, starpu_data_handle_t const input_handle)
// {
...
//     for (int i = 0; i < conv.num_filters; i++)
//     {
// 		starpu_data_handle_t const sub_dl_dout = starpu_data_get_sub_data(dl_dout, 1, i);
