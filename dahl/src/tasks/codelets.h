...
DEFINE_STARPU_CODELET(any_sub, 3, false, STARPU_R, STARPU_R, STARPU_REDUX); // Last mode can be either STARPU_REDUX or STARPU_RW
DEFINE_STARPU_CODELET(any_add, 3, false, STARPU_R, STARPU_R, STARPU_REDUX); // Last mode can be either STARPU_REDUX or STARPU_RW
DEFINE_STARPU_CODELET(any_add_value, 2, false, STARPU_R, STARPU_W);
DEFINE_STARPU_CODELET(any_clip, 2, false, STARPU_R, STARPU_W);
...
DEFINE_STARPU_CODELET(any_fill, 1, false, STARPU_W);
...
DEFINE_STARPU_CODELET(convolution_2d, 3, false, STARPU_R, STARPU_R, STARPU_W);
DEFINE_STARPU_CODELET(convolution_2d_backward_filters, 3, false, STARPU_R, STARPU_R, STARPU_REDUX); // Last mode can be either STARPU_REDUX or STARPU_RW
DEFINE_STARPU_CODELET(convolution_2d_backward_input, 3, false, STARPU_R, STARPU_R, STARPU_W);
DEFINE_STARPU_CODELET(convolution_2d_backward_input_padding_free, 3, false, STARPU_R, STARPU_R, STARPU_RW);
