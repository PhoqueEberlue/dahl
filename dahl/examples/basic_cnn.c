                   ...
                   size_t batch_size, size_t num_samples)
{
    ...
    num_samples = 500; // Only use first 1k samples for now
...
int main(int argc, char **argv)
{
    ...
    dahl_dataset* dataset = dataset_load_factice(network_arena, (dahl_shape3d){ .x = 512, .y = 512, .z = 1 }, 500);
