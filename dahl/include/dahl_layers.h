...
dahl_tensor_part* convolution_forward(dahl_arena*, dahl_convolution*, dahl_tensor_part const* input_batch);
dahl_tensor_part* convolution_backward(dahl_arena*, dahl_convolution*, dahl_tensor_part const* dl_dout_batch, 
                                  double learning_rate, dahl_tensor_part const* input_batch);
...
dahl_tensor_part* pooling_forward(dahl_arena*, dahl_pooling*, dahl_tensor_part const* input_batch);
dahl_tensor_part* pooling_backward(dahl_arena*, dahl_pooling*, dahl_tensor_part const* dl_dout_batch);
...
dahl_matrix_part* dense_forward(dahl_arena*, dahl_dense*, dahl_matrix_part const* input_batch);
...
// - `learning_rate`
dahl_matrix_part* dense_backward(dahl_arena*, dahl_dense*, dahl_matrix_part const* dl_dout_batch, 
                            dahl_matrix_part const* input_batch, dahl_fp learning_rate);
