...
void task_cross_entropy_loss_gradient_batch(dahl_matrix_part const* prediction_batch_p, dahl_matrix_part const* target_batch_p, dahl_matrix_part* gradient_batch_p);

dahl_matrix_part* task_cross_entropy_loss_gradient_batch_init(dahl_arena* arena, dahl_matrix_part const* prediction_batch_p, 
                                                                dahl_matrix_part const* target_batch_p);
// Performs `out` = `in` x `kernel`, where:
